...
const AIInsights: React.FC = () => {
    ...
    return (
        <div className="bg-surface p-6 rounded-xl border border-surface-accent">
            ...
            {insights ? (
                 <div className="prose prose-invert prose-sm max-w-none text-text-secondary leading-relaxed" dangerouslySetInnerHTML={{ __html: insights.replace(/\n/g, '<br />') }}></div>
            ) : (
                ...
                {incomeVsExpenseData.length > 0 ? (
                    <ResponsiveContainer width="100%" height="90%">
                        <BarChart data={incomeVsExpenseData} margin={{ top: 5, right: 20, left: -10, bottom: 5 }}>
                            ...
                            <YAxis stroke="var(--chart-axis-stroke)" fontSize={12} />
                            <Tooltip 
                                contentStyle={{ 
