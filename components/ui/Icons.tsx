...
export const TransactionsIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 20V4" /><path d="m4 12 8 8 8-8" />
  </svg>
);
export const CategoriesIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const InvestmentsIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <line x1="12" x2="12" y1="20" y2="10" /><path d="M18 20V4" /><path d="M6 20v-4" />
  </svg>
);
...
export const BrainCircuitIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 2a2.5 2.5 0 0 1 3 4" /><path d="M12 2a2.5 2.5 0 0 0-3 4" /><path d="M14 13a2.5 2.5 0 0 1 3 4" /><path d="M14 13a2.5 2.5 0 0 0-3 4" /><path d="M3 10a2.5 2.5 0 0 1 3 4" /><path d="M3 10a2.5 2.5 0 0 0-3 4" /><path d="M24 10a2.5 2.5 0 0 1-3 4" /><path d="M24 10a2.5 2.5 0 0 0 3 4" /><path d="M12 2v2.5" /><path d="M12 17v4.5" /><path d="M14 13h7.5" /><path d="M2.5 10H7" /><path d="M17.5 6.5 14 13" /><path d="M6.5 6.5 10 13" /><path d="M6.5 17.5 10 11" /><path d="m14 11 3.5 6.5" />
  </svg>
);
...
export const Wand2Icon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="m3 21 3.05-3.05" /><path d="m6.05 17.95 3-3" /><path d="m9.05 14.95 3-3" /><path d="m12.05 11.95 3-3" /><path d="m15.05 8.95 3-3" /><path d="m18.05 5.95 3-3" /><path d="m21 3-8.5 8.5" /><path d="M6.05 21.95 3 19l6-6 3 3-6 6Z" />
    </svg>
);

export const IncomeIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 2v20" /><path d="m5 7 7-5 7 5" />
    </svg>
);

export const ExpenseIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 22V2" /><path d="m19 15-7 7-7-7" />
    </svg>
);

export const BalanceIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 20V4" /><path d="M6 10h12" /><path d="M6 14h12" />
    </svg>
);

export const LandmarkIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
